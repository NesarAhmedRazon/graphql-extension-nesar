...
require_once GQL_EXTNESAR_PLUGIN_DIR . 'includes/shortcode/theme/spacer.php';
require_once GQL_EXTNESAR_PLUGIN_DIR . 'includes/shortcode/theme/testimonials.php';
